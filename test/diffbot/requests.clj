...
(facts "Building requests"
       (fact "The protocol is https"
             (-> (build-request-url "article" "token" "https://www.diffbot.com")
                 url-like
                 protocol-of)
             => "http")
       ...
       (fact "The host uri can be overridden"
             (-> (build-request-url "article" "token" "https://www.diffbot.com" :api-url "localhost")
                 url-like
                 host-of)
             => "localhost")
       ...
       (fact "The api version can be overridden"
             (-> (build-request-url "article" "token" "https://www.diffbot.com" :api-version "v3")
                 url-like
                 path-of)
             => "/v3/article")
)
...
(facts "Mandatory parameters"
       (fact "The token is added as a query parameter"
             (-> (build-request-url "article" "some-token" "https://www.diffbot.com")
                 url-like
                 query-of
                 split-query-string
                 (get-in ["token"]))
...
(facts "Optional parameters"
       (fact "A callback can be added as a query parameter"
             (-> (build-request-url "article" "token" "https://www.diffbot.com" :callback "callbackfn")
                 url-like
                 query-of
                 split-query-string
                 (get-in ["callback"]))
       ...
       (fact "A timeout can be added as a query parameter"
             (-> (build-request-url "article" "token" "https://www.diffbot.com" :timeout 100)
                 url-like
                 query-of
                 split-query-string
                 (get-in ["timeout"]))
       ...
       (fact "A list of fields can be added as a query parameter - one field"
             (-> (build-request-url "article" "token" "https://www.diffbot.com" :fields ["a-field"])
                 url-like
                 query-of
                 split-query-string
                 (get-in ["fields"]))
       ...
       (fact "Multiple fields are comma separated"
             (-> (build-request-url "article" "token" "https://www.diffbot.com" :fields ["a-field" "b-field" "c-field"])
                 url-like
                 query-of
                 split-query-string
                 (get-in ["fields"]))
       ...
       (fact "Fields can contain wildcards and parems"
             (-> (build-request-url "article" "token" "https://www.diffbot.com" :fields ["a-field" "b-field(b-1,b-2)" "c-field(*)"])
                 url-like
                 query-of
                 split-query-string
                 (get-in ["fields"]))
